<?php 
namespace pluginbrandslug\framework;
/**
 * Digihood sessions
 *
 * 
...
if( ! class_exists( 'd1g1Session' ) )
{
	class d1g1Session
	{
        ...
        private static function default_message($type) {
            if ($type == 'success'){
                return __("Nastavení bylo úspěšně aktualizováno", D1G1_BRANDING);
            } else {
                return __("Nastavení se nepodařilo uložit. Zkuste to, prosím, znovu.", D1G1_BRANDING);
            }
        }
