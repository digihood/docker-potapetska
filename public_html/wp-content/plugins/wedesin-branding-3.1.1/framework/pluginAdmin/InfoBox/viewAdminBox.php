...
use pluginbrandslug\framework\pluginAdmin\InfoBox\getRestApiRequest;
use pluginbrandslug\framework\d1g1UTM;
/**
		...
		private function display_box($type="plugins") { 
            ...
            if($data) {
				echo '<div class="card'.($type == 'plugins' ? ' info' : '').'">';
					...
					if ($type == 'pluginsnews'){ 
						echo 	'<h2">' .__("Novinky na webu Plugins DigiHood", D1G1_BRANDING).'</h2><br>';
					}
					?>
